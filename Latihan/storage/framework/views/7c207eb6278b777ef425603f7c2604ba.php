...
<?php $__env->startSection('title', 'Galeri - Geosite Danau Toba'); ?>
...
.galeri-hero {
    height: auto;
    min-height: 400px;
    background: url('<?php echo e(asset("image/galeri.jpg")); ?>');
...
<script>
    ...
    const galeriData = {
        'Biodiversity': [
            <?php $__currentLoopData = $galeris->where('kategori', 'Biodiversity'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { src: '<?php echo e(asset('storage/' . $item->gambar)); ?>', caption: '<?php echo e($item->judul); ?>' },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ],
        'Geodiversity': [
            <?php $__currentLoopData = $galeris->where('kategori', 'Geodiversity'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { src: '<?php echo e(asset('storage/' . $item->gambar)); ?>', caption: '<?php echo e($item->judul); ?>' },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ],
        'Culture diversity': [
            <?php $__currentLoopData = $galeris->where('kategori', 'Culture diversity'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { src: '<?php echo e(asset('storage/' . $item->gambar)); ?>', caption: '<?php echo e($item->judul); ?>' },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ]
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 2\Proyek Akhir 1 - PA 1\Template Proyek Akhir - Sibaganding\Sibaganding\Latihan\resources\views/pages/galeri.blade.php ENDPATH**/ ?>